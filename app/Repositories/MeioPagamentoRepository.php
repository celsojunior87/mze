...
class MeioPagamentoRepository
{
    ...
    public function findById($id)
    {
        try {
            ...
            return $this->success("Detalhes dos Tipo Pagamento", $tipoPagamento);
        } catch (\Exception $e) {
    ...
    public function saveOrUpdate(TipoPagamentoRequest $request, $id = null)
    {
        ...
        try {
            ...
            if ($id && !$tipoPagamento) return $this->error("Não Possui o Tipo Pagamento $id", 404);
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            // Check the user
            if (!$tipoPagamento) return $this->error("Não Existe o Tipo Pagamento $id", 404);

            // Delete the user
            $tipoPagamento->delete();
            DB::commit();
            return $this->success("Tipo Pagamento deletado com Sucesso", $tipoPagamento);
        } catch (\Exception $e) {
            DB::rollBack();
            return $this->error($e->getMessage(), $e->getCode());
        }
